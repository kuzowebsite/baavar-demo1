...
const BodyContent = ({ onLottoClick }) => { 
  ...
  const getImageStyles = () => {
    ...
    if (windowWidth <= 390) return { width: '210px', left: '-40px', bottom: '0' };
    if (windowWidth <= 391) return { width: '155px', left: '-45px', bottom: '0' };
    if (windowWidth <= 392) return { width: '135px', left: '-35px', bottom: '0' };
    if (windowWidth <= 393) return { width: '215px', left: '-55px', bottom: '0' };
    ...
    if (windowWidth <= 412) return { width: '260px', left: '-65px', bottom: '0' };
    ...
    if (windowWidth <= 426) return { width: '140px', left: '-40px', bottom: '0' };
        if (windowWidth <= 430) return { width: '260px', left: '-60px', bottom: '0' };
