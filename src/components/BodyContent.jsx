...
const BodyContent = ({ onLottoClick }) => { 
  ...
  const getImageStyles = () => {
    if (windowWidth <= 295) return { width: '105px', left: '-34px', bottom: '-20px' };
    if (windowWidth <= 312) return { width: '105px', left: '-34px', bottom: '-20px' };
    if (windowWidth <= 320) return { width: '135px', left: '-34px', bottom: '-20px' };
    if (windowWidth <= 332) return { width: '125px', left: '-34px', bottom: '-20px' };
    if (windowWidth <= 333) return { width: '155px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 334) return { width: '155px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 343) return { width: '145px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 344) return { width: '155px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 353) return { width: '125px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 360) return { width: '140px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 366) return { width: '120px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 370) return { width: '150px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 374) return { width: '130px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 375) return { width: '200px', left: '-50px', bottom: '-20px' };
    if (windowWidth <= 377) return { width: '150px', left: '-50px', bottom: '-20px' };
    if (windowWidth <= 381) return { width: '140px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 384) return { width: '140px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 388) return { width: '150px', left: '-50px', bottom: '-20px' };
    if (windowWidth <= 389) return { width: '130px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 390) return { width: '210px', left: '-40px', bottom: '-20px' };
    if (windowWidth <= 391) return { width: '155px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 392) return { width: '135px', left: '-35px', bottom: '-20px' };
    if (windowWidth <= 393) return { width: '215px', left: '-55px', bottom: '-20px' };
    if (windowWidth <= 394) return { width: '140px', left: '-50px', bottom: '-20px' };
    if (windowWidth <= 396) return { width: '120px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 400) return { width: '150px', left: '-45px', bottom: '-20px' };
    if (windowWidth <= 412) return { width: '260px', left: '-65px', bottom: '-20px' };
    if (windowWidth <= 414) return { width: '150px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 415) return { width: '130px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 416) return { width: '120px', left: '-20px', bottom: '-20px' };
    if (windowWidth <= 422) return { width: '180px', left: '-40px', bottom: '-20px' };
    if (windowWidth <= 423) return { width: '120px', left: '-30px', bottom: '-20px' };
    if (windowWidth <= 424) return { width: '180px', left: '-40px', bottom: '-20px' };
    if (windowWidth <= 426) return { width: '140px', left: '-40px', bottom: '-20px' };
        if (windowWidth <= 430) return { width: '260px', left: '-60px', bottom: '-20px' };
        if (windowWidth <= 530) return { width: '130px', left: '-30px', bottom: '-20px' };
    if (windowWidth < 768) return { width: '270px', left: '-80px', bottom: '-20px' };
    if (windowWidth >= 768 && windowWidth < 1024) return { width: '200px', left: '-40px', bottom: '-20px' }; 
